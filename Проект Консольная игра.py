...
zl = ["Шутка 1","Шутка 2","Шутка 3","Шутка 4"]

if age >= 15:
    print('придумай шутку {0}'.format(name), 'продолжи шутку: {0}'.format(zl[0]))
    input()
elif age <= 13:
    print('придумай шутку {0}'.format(name), 'продолжи шутку: {0}'.format(zl[1]))
    input()
else:
